...
#define DISPLAY_CLASS_TYPE \
  GxEPD2_3C<GxEPD2_750c_GDEY075Z08_inverted, GxEPD2_750c_GDEY075Z08_inverted::HEIGHT>  // or HEIGHT/2 etc. for partial page buffer and memory savings
