...
has _symbol_map_as_array => sub {
    return [
        ...
        { code => 'heavysleetshowers',            description => { en => 'Heavy sleet showers',             cz => 'Silný déšť se sněhem' },            openweather_id => 613 },
        ...
        { code => 'heavysleet',                   description => { en => 'Heavy sleet',                     cz => 'Silný déšť se sněhem' },            openweather_id => 613 },
        { code => 'lightsleetandthunder',         description => { en => 'Light sleet and thunder',         cz => 'Slabý déšť se sněhem a bouřky' },   openweather_id => 220 },
        { code => 'sleetandthunder',              description => { en => 'Sleet and thunder',               cz => 'Déšť se sněhem a bouřky' },         openweather_id => 221 },
        { code => 'heavysleetandthunder',         description => { en => 'Heavy sleet and thunder',         cz => 'Silný déšť se sněhem a bouřky' },   openweather_id => 222 },
