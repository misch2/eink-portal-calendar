...
public class PublicHolidayService : IPublicHolidayService
{
    ...
    private static readonly Dictionary<string, (string English, string Czech)> CzechHolidayNames = new()
    {
        ...
        { "04-01", ("Easter Monday", "Velikonoční pondělí") },  // Movable - will be set dynamically  
        { "05-01", ("Labour Day", "Svátek práce") },
        { "05-08", ("Liberation Day", "Den vítězství") },
        { "07-05", ("Saints Cyril and Methodius Day", "Den slovanských věrozvěstů Cyrila a Metoděje") },
        { "07-06", ("Jan Hus Day", "Den upálení mistra Jana Husa") },
        { "09-28", ("St. Wenceslas Day", "Den české státnosti") },
        { "10-28", ("Independent Czechoslovak State Day", "Den vzniku samostatného československého státu") },
        { "11-17", ("Struggle for Freedom and Democracy Day", "Den boje za svobodu a demokracii") },
        { "12-24", ("Christmas Eve", "Štědrý den") },
        { "12-25", ("Christmas Day", "1. svátek vánoční") },
        { "12-26", ("St. Stephen's Day", "2. svátek vánoční") }
    };
