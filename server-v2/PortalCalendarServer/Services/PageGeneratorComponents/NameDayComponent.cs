...
/// Based on the SvatkyAPI integration that provides Czech name day information.
/// </summary>
public class NameDayComponent : BaseComponent
{
    ...
    private Dictionary<string, string> cz_name_days = new Dictionary<string, string>
    {
        { "0101", "Nov˝ rok" },
        { "0201", "Karina / Vasil" },
    ...
    public NameDayInfo? GetNameDayInfo()
    {
        ...
        var key = _date.ToString("ddMM", CultureInfo.InvariantCulture);
        if (cz_name_days.TryGetValue(key, out var name))
        {
